...
module ApplicationHelper
    ...
    def send_email(product, subject, message, user)
      ...
      content = "<html><head><style type='text/css'>body,html,.body{background:#D3D3D3!important;}</style></head><body><container><spacer size='16'></spacer><row><columns><center><img class='small-float-center' width='500px' height='300px' src=#{Listing.find_by_id(product.id).imagefront}></center></columns></row><row><columns large='8'><center><h2>RVnB</h2></center></columns></row><row><columns large='6'><center><h4>Hi! Its RVNB team!</h4><br><p>#{message}</p><br><p>Follow: https://rvnb.herokuapp.com/listings/#{product.id} to view</p><center></columns><columns large='6'><br><p>Phone: +1 866-338-7870 Line 5</p><br><p>Email:sales@tdcdigitalmedia.com</p></columns><columns large='4'><img class='small-float-center' width='100px' height='100px' src='//s3-us-west-2.amazonaws.com/rvnb/rvnblogo.jpg' alt='RVnB'></columns></row><row></row></container><body></html>"
