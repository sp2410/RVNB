...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { enddate: @availability.enddate, startdate: @availability.startdate } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { enddate: @availability.enddate, startdate: @availability.startdate } }
